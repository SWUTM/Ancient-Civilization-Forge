...
import net.swutm.ancientcivilization.structures.SkyStructures;
...
public class STStructures {
     ...
     */
    public static final DeferredRegister<StructureType<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(Registry.STRUCTURE_TYPE_REGISTRY, ancientcivilization.MOD_ID);
